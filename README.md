...
*   **🌐 Model Server (Experimental)**: Host your downloaded LLM models as OpenAI-compatible API endpoints directly from your Android device. Connect other tools and agents to your phone over the local network.
