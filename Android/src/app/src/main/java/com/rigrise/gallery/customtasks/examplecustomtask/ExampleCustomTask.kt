...
package com.rigrise.gallery.customtasks.examplecustomtask
...
class ExampleCustomTask @Inject constructor() : CustomTask {
  override val task: Task =
    Task(
      ...
      docUrl =
        "https://github.com/google-ai-edge/gallery/Android/src/app/src/main/java/com/rigrise/gallery/customtasks/common/CustomTask.kt",
      sourceCodeUrl =
        "https://github.com/google-ai-edge/gallery/Android/src/app/src/main/java/com/rigrise/gallery/customtasks/examplecustomtask/ExampleCustomTask.kt",
      models =
        mutableListOf(
          Model(
            name = "Local model",
