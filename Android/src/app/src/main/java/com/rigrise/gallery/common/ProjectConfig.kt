...
package com.rigrise.gallery.common
...
object ProjectConfig {
  ...
  //
  // If you have a Hugging Face access token, you can set it here to download
  // models without OAuth. Get your token from: https://huggingface.co/settings/tokens
  // You need a "Read" token for downloading public models.
  const val HF_ACCESS_TOKEN = ""
